  ...
  return (
    <footer className="border-t border-white/10 bg-bg-primary pb-10 pt-20">
      <div className="container mx-auto px-6">
        <div className="mb-16 grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-accent-gold transition-colors hover:text-white"><Instagram size={20} /></a>
              <a href="#" className="text-accent-gold transition-colors hover:text-white"><Facebook size={20} /></a>
              <a href="#" className="text-accent-gold transition-colors hover:text-white"><Twitter size={20} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm uppercase tracking-wider text-neutral-grey">
              <li><Link href="/" className="transition-colors hover:text-accent-gold">Home</Link></li>
              <li><Link href="/products" className="transition-colors hover:text-accent-gold">Collection</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="mb-6 text-sm font-bold uppercase tracking-widest text-white">Customer Care</h4>
            <ul className="space-y-4 text-sm uppercase tracking-wider text-neutral-grey">
              <li><a href="#" className="transition-colors hover:text-accent-gold">Shipping Policy</a></li>
              <li><a href="#" className="transition-colors hover:text-accent-gold">Returns & Exchanges</a></li>
              <li><a href="#" className="transition-colors hover:text-accent-gold">Privacy Policy</a></li>
              <li><a href="#" className="transition-colors hover:text-accent-gold">FAQs</a></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col items-center justify-between space-y-4 border-t border-white/10 pt-8 text-xs uppercase tracking-widest text-neutral-grey md:flex-row md:space-y-0">
