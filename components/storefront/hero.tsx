    ...
    <section className="relative flex h-screen items-center overflow-hidden bg-bg-primary">
      ...
      <div className="container relative z-10 mx-auto px-6">
        <div className="max-w-2xl">
          ...
          >
            <span className="mb-4 block text-sm font-medium uppercase tracking-[0.3em] text-accent-gold">
            ...
            <p className="mb-10 max-w-lg text-lg leading-relaxed text-neutral-grey">
              Discover our collection of handcrafted luxury jewellery designed
              for timeless elegance and unforgettable moments.
            </p>

            <div className="flex flex-col space-y-4 sm:flex-row sm:space-x-6 sm:space-y-0">
              <Link
                href="/products"
                className="group flex items-center justify-center bg-accent-gold px-10 py-4 text-sm font-bold uppercase tracking-widest text-bg-primary transition-colors hover:bg-white"
              >
                Explore Collection
                <ArrowRight
              ...
              <Link
                ...
                className="flex items-center justify-center border border-accent-gold px-10 py-4 text-sm font-bold uppercase tracking-widest text-accent-gold transition-all hover:bg-accent-gold hover:text-bg-primary"
              >
                View Best Sellers
              </Link>
            </div>
